...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Dhritiman Saha/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Dhritiman Saha' => 'dhritimancorp@gmail.com' }
  s.source           = { :git => 'https://github.com/Dhritiman Saha/BlinkingLabel.git', :tag => s.version.to_s }
